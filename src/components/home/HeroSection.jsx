  ...
  return (
    <HeroSectionWrapper imageArray={homeHeroUrls} wrapperHeight="100%">
      ...
      <div className="container mx-auto">
        <div className="flex flex-col justify-center items-start mt-24 pt-20 px-4 ">
          <motion.div>
          ...
          <motion.div
            className="flex flex-wrap justify-evenly items-center gap-4 md:mt-32 sm:mt-10 mt-4 relative  border-slate-300 border-2 p-4 md:p-6  rounded-xl z-50 opacity-40 bg-transparent w-full "
            initial="hidden"
            animate="visible"
